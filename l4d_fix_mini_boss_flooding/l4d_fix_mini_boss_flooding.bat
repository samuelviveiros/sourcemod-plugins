@ECHO OFF
TITLE [L4D] Fix Mini Boss Flooding - Plugin Setup v1.0.0
CLS
ECHO --==<(   [L4D] Fix Mini Boss Flooding - Plugin Setup v1.0.0 -- by Dartz8901   )>==--

SET plugin_name=l4d_fix_mini_boss_flooding
